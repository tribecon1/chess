...
public class EscapeSequences {
    ...
    public static final String SET_DEFAULT_BG_COLOR = "\u001B[0m";
    ...
    public static final String SET_BG_COLOR_LIGHT_BROWN = SET_BG_COLOR + "94m";
    ...
    public static final String SET_BG_COLOR_YELLOW = SET_BG_COLOR + "229m";
    public static final String SET_BG_COLOR_DARK_YELLOW = SET_BG_COLOR + "226m";
